...
steps: Number of steps taking in a 5-minute interval (missing values are coded as ð½ð°) </br>
...
1. Make a time series plot (i.e. ðð¢ðð = "ð") of the 5-minute interval (x-axis) and the average number of steps taken, averaged across all days (y-axis)
...
2. Make a panel plot containing a time series plot (i.e. ðð¢ðð = "ð") of the 5-minute interval (x-axis) and the average number of steps taken, averaged across all weekday days or weekend days (y-axis). See the README file in the GitHub repository to see an example of what this plot should look like using simulated data.
